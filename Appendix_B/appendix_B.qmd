...
**This Appendix contains additional results associated with the simulation study of *ReefCloud: A Scalable Framework for Predicting Coral Trends and Attribute Changes.*** 

**The R code for running the modelling pipeline is provided in the source files associated with the Appendix. To begin, download and install the repository available on [GitHub](https://github.com/open-AIMS/RC_modelling).** 
...
#setwd("c:/Users/jvercell/OneDrive - Australian Institute of Marine Science/AIMS/01_Research projects/ReefCloud/SP_models/FRK_dev/Spatio-temporal model/Appendix_B")
