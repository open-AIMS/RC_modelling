...
exclude_patterns <- c("R", "scripts", "old", "extra", "resources", ".git")
...
combined_table$Title_of_run <- factor(combined_table$Title_of_run, levels = c("Short-term", "Medium-term", 
                                                                               "Long-term", "Temporally-sparse" ))
